...
pose_types = ["male_thin_top", "male_thin_upper", "male_wide_top", "male_wide_upper", "female_thin_top", "female_thin_upper", "female_wide_top", "female_wide_upper"]

for image_number in range(13, 155):
    ...
    for pose_number in range(0, len(pose_types)):
        ...
        pwarped_tex_img_np_extract = np.load("/home/kate/Unselfie/UniHuman/code/Body_Texture_Array.npy")
        ...
        pwarped_tex_img_np_extract_image.save("/home/kate/Unselfie/UniHuman/code/Body_Textures/Image" + str(image_number) + "_" + str(pose_types[pose_number]) + "_body_texture.png")

        # Yay!
        print("PoseTransfer Testing complete!")
