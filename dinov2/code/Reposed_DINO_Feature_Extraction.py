### ABOUT THIS PROGRAM: Obtains the DINOv2 features from reposed images generated by UniHuman
...
for i in range(num_imgs):
    ...
    plt.savefig('/home/kate/Selfie2Portrait/dinov2/code/pca_results_for_reposed/image' + str(int(i/4) + 1) + '_' + str(pose) + '.jpg')
